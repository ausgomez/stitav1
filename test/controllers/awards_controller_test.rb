...
class AwardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post awards_url, params: { award: { member_id: @award.member_id, name: @award.name, year: @award.year } }
    end
  ...
  test "should update award" do
    patch award_url(@award), params: { award: { member_id: @award.member_id, name: @award.name, year: @award.year } }
