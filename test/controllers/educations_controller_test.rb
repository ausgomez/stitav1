...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { degree: @education.degree, end: @education.end, info: @education.info, member_id: @education.member_id, school: @education.school, start: @education.start } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { degree: @education.degree, end: @education.end, info: @education.info, member_id: @education.member_id, school: @education.school, start: @education.start } }
